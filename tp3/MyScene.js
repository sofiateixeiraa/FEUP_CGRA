...
export class MyScene extends CGFscene {
    ...
    updateObjectComplexity(){
        ...
        // daria assim mas preferimos adicionar o método updateBuffers na classe MyTangram e na classe MyUnitCube
        /*if(this.selectedObject != 3 && this.selectedObject != 4)
    ...
    initMaterials() {
        ...
        this.wood.setAmbient(0.5882, 0.2941, 0, 1.0);
        this.wood.setDiffuse(0.5882, 0.2941, 0, 1.0);
